    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-light shadow">
          <div className="container d-flex justify-content-between align-items-center">
            {/* Enlace al inicio */}
            <Link to="/portalHome" className="navbar-brand text-danger logo h1 align-self-center">SecretSuites</Link>
          ...
          <div className="modal-dialog modal-lg" role="document">
            ...
            <form action="" method="get" className="modal-content modal-body border-0 p-0">
              <div className="input-group mb-2">
                ...
                <button type="submit" className="input-group-text bg-danger text-light">
    ...
    <header className="bg-blue-gray">
        ...
        <div className="row align-items-start">
          ...
          <div className="col-md">
            <div className="d-flex align-items-center">
              ...
              <div>secretsuites@gmail.com</div>
            </div>
          </div>
      ...
      <nav className="navbar navbar-expand-lg navbar-light shadow">
        <div className="container d-flex justify-content-between align-items-center">{/* Enlace al inicio */}
          <Link to="/" className="navbar-brand text-danger logo h1 align-self-center">SecretSuites</Link>
          ...
          <div className="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
            <div className="flex-fill">
              <ul className="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                ...
                <li className="nav-item">
                  <Link to="/shop" className="nav-link">Moteles</Link>
                </li>
                <li className="nav-item">
